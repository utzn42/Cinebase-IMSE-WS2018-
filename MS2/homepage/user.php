...
FROM ticket
	...
	LEFT JOIN hall ON screening.hall_id = hall.hall_id WHERE customer_id = \"$customer_id\"";
        ...
        <button class="changePassword" onclick="checkPassword('<?php echo $_SESSION['password']; ?>')">Change Password
        </button>
        <button class="deleteMyAccount" onclick="deleteAccount(<?php echo $_SESSION['customer_id']; ?>)">Delete my
            Account
        </button>
